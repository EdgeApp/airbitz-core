...
public:
    ...
    std::string carePackageName() const { return dir() + "CarePackage.json"; }
    std::string loginPackageName() const { return dir() + "LoginPackage.json"; }
    std::string rootKeyPath() const { return dir() + "RootKey.json"; }
