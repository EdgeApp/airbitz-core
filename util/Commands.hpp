...
abcd::Status otpOff(int argc, char *argv[]);
abcd::Status otpOn(int argc, char *argv[]);
abcd::Status otpStatus(int argc, char *argv[]);
abcd::Status otpGetSecret(int argc, char *argv[]);
abcd::Status otpSetSecret(int argc, char *argv[]);
abcd::Status otpSignIn(int argc, char *argv[]);
